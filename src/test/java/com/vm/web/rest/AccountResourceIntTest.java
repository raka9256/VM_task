...
import com.vm.config.Constants;
import com.vm.VmApp;
import com.vm.domain.Authority;
import com.vm.domain.User;
import com.vm.repository.AuthorityRepository;
import com.vm.repository.UserRepository;
import com.vm.security.AuthoritiesConstants;
import com.vm.service.MailService;
import com.vm.service.dto.UserDTO;
import com.vm.service.dto.PasswordChangeDTO;
import com.vm.web.rest.errors.ExceptionTranslator;
import com.vm.web.rest.vm.KeyAndPasswordVM;
import com.vm.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = VmApp.class)
